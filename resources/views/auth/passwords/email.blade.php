                    ...
                    <div class="login-right">
                        <div class="login-right-wrap">
                            ...
                            <form method="POST" action="{{ route('password.email') }}">
                                ...
                                <div class="form-group">
                                    <button class="btn btn-success btn-block" type="submit">Reset My Password</button>
                                </div>
                                <div class="form-group mb-0">
                                    {{-- <button class="btn btn-primary primary-reset btn-block"
                                        type="submit">Login</button> --}}
                                    <a href="{{ route('login') }}"
                                        class="btn btn-success primary-reset btn-block"><i class="fas fa-sign-out-alt"></i> Login</a>
                                </div>
                            </form>
